...
public class ObjectFactory {
    ...
    private final static QName _ActivateGloveAddress_QNAME = new QName("http://tempuri.org/", "gloveAddress");
    ...
    public JAXBElement<String> createActivateGloveAddress(String value) {
        return new JAXBElement<String>(_ActivateGloveAddress_QNAME, String.class, Activate.class, value);
    }
    ...
    public JAXBElement<String> createConnectGloveAddress(String value) {
        return new JAXBElement<String>(_ActivateGloveAddress_QNAME, String.class, Connect.class, value);
    }
    ...
    public JAXBElement<String> createDisconnectGloveAddress(String value) {
        return new JAXBElement<String>(_ActivateGloveAddress_QNAME, String.class, Disconnect.class, value);
    }
